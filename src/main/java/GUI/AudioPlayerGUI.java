...
public class AudioPlayerGUI {
    ...
    private void createAndShowGUI() {
        ...
        startStopButton = new JButton("<html>&#9658;</html>"); // Это Unicode-символ для ▶
        startStopButton.setFont(new Font("Arial", Font.PLAIN, 16)); // Вы можете настроить шрифт по вашему вкусу
